...
@Component({
  selector: 'app-ospm-section',
  templateUrl: './ospm-section.component.html',
  styleUrls: ['./ospm-section.component.css']
})
export class OspmSectionComponent implements OnInit {
      ...
      series: [
        {
          name: "WESTML_FF1",
          type: "column",
          data: [1860, 2012, 2162, 224, 500, 6000],
        },
        {
          name: "WESTML_FF2",
          type: "column",
          data: [1760, 2012, 2162, 224, 500, 6000]
        },
        {
          name: "WESTML_FF2",
          type: "column",
          data: [1960, 2012, 2162, 224, 500, 6000]
        },
        {
          name: "EASTNL_FFS4",
          type: "column",
          data: [1560, 2012, 2162, 224, 1001, 2000]
        },
        {
          name: "EASTNL_FFS5",
          type: "column",
          data: [1260, 2012, 2162, 224, 1001, 2000]
        },
        {
          name: "CENTRALNL_FFS6",
          type: "column",
          data: [1460, 2012, 2162, 224, 500, 900]
        },
        {
          name: "CENTRALNL_FFS7",
          type: "column",
          data: [1360, 2012, 2162, 224, 500, 900]
        },
        {
          name: "CENTRALNL_FFS8",
          type: "column",
          data: [1760, 2012, 2162, 224, 500, 900]
        },
        {
          name: "MTTR",
          type: "line",
          data: [10.73, 10.57, 9.76, 9.46, 7.20, 9.36]
        }
        // {
        //   name: "MTTR",
        //   type: "line",
